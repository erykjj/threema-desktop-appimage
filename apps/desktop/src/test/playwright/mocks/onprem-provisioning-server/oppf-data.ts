 ...
 */
function getMockDomainsRuleForSpki(spki: string): DomainsRule {
    return {
        fqdn: '*.3ma.ch',
    ...
    switch (variant) {
        ...
        case 'wrong-signature':
            return createOppfString({
                ...
                keypair: OPPF_SIGNING_KEYPAIRS.untrusted,
                licenseExpiry: '2027-02-01',
            });
        default:
 ...
 */
function createOppfString(options: {
