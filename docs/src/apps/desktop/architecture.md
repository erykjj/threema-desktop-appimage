...
This file documents some aspects of the structure and architecture of the Threema Desktop
application based on Electron. It is by no means complete, but should help with understanding and
