...
export default createRule({
    ...
    meta: {
        ...
        schema: [],
        messages: {
            typedArrayLength: 'Do not use TypedArray.length, use TypedArray.byteLength instead.',
        },
        fixable: 'code',
    },
    defaultOptions: [],
    create(context) {
        ...
        return {
            'MemberExpression[property.name="length"]'(esNode: TSESTree.MemberExpression): void {
                const tsNode = parserServices.esTreeNodeToTSNodeMap.get(esNode.object);
